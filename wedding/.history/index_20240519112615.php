...
if (!empty($_POST)) {
    ...
    if (empty($errors)) {
        ...
        if (mail($toEmail, $emailSubject, $body, $headers)) {
			...
			$stmt = $conn->prepare("INSERT INTO rsvp (FullName, Email, NumberOfGuests) VALUES (?, ?, ?)");
        ...
        $bodyParagraphs = ["Name: {$name}", "Email: {$email}", "Message:", $message];
        $bodyOLD = join(PHP_EOL, $bodyParagraphs);
        $body2 = "Thank you for your RSVP on EmileyAndNoah.com<br><br>If there is a change in your RSVP, please contact Emiley.<br><br>Here's a copy of your RSVP:<br>Name: {$name} <br>Email: {$email}<br>Guests: {$guests}<br><br>The wedding is INVITE only and will be held at the Hinton Historical Freight Depot on Saturday, September 21, 2024 at 3pm.<br><br>Hinton Historical Freight Depot<br>509 Commercial Street<br>Hinton, WV 25951 <br><br><a href='https://www.google.com/maps/dir//509+Commercial+St,+Hinton,+WV+25951/@37.676769,-80.8906277,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x884e812f85e5f369:0x6f847295a794d6c6!2m2!1d-80.8880528!2d37.676769?entry=ttu'>Click here to get directions.</a><br><br><strong>A MESSAGE FROM THE BRIDE AND GROOM:</strong><br>This is a very special day and we ask that you respect our wishes to unplug the phones and live in the moment with us. There will be a moment we allow you to take a picture or two before the ceremony. Once we are pronounce the Stovers you are free to use your phones and take as many pictures as you wish.<br><br>We would much rather look out and see all the people we care about and not the phones.<br><br><em>- Emiley & Noah (<a href='https://www.emileyandnoah.com'>www.emileyandnoah.com</a>)</em><br><br>";
	...
	<div id="fh5co-couple">
		...
		<br><br>
			<div class="animate-box text-center px-5 mx-5 p-5 m-5" style="width:85%;margin:auto;">
				<div class="container"><h2>Wedding Details</h2>
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap animate-box">
									...
									<div class="event-col">
										<i class="icon-clock"></i>
										<span>Following<br>Ceremony</span>
									</div>
									<div class="event-col">
										<i class="icon-calendar"></i>
										<span>Saturday</span>
				...
				<div class="col-md-12 col-md-offset-0">
					<ul class="timeline animate-box">
						<li class="animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">1996</h3>
									<span class="date">June 22nd, 1996</span>
								</div>
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">1999</h3>
									<span class="date">December 30th, 1999</span>
								</div>
								<div class="timeline-body">
									<p>Emiley was born.</p>
								</div>
						...
						<li class="animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">Time goes on</h3>
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">They meet on Instagram</h3>
									<span class="date">February 15th, 2021</span>
								</div>
								<div class="timeline-body">
									<p>It was the middle of the pandemic, so of course it was online.</p>
								</div>
							</div>
						</li>
						<li class="animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">They finally meet in person</h3>
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h3 class="timeline-title">He proposed</h3>
									<span class="date">August 5th, 2023</span>
								</div>
								<div class="timeline-body">
									<p>At the Georgia Aquarium in front of the shark exhibit.</p>
								</div>
							</div>
						</li>
						<li class="animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="date">September 21st, 2024</span>
								</div>
								<div class="timeline-body">
									<p>The date was chosen because of one of Emiley‘s favorite song, September by Earth, wind and fire. We later found out that the hobbit was released on the same date which is one of Noah’s favorite books!</p>
								</div>
							</div>
						</li>
			    	</ul>
...
<form class="form-inline" action="index.php" method="POST">
	...
	var d = new Date("2024-09-21 15:00");
