...
if (!empty($_POST)) {
    ...
    if (empty($errors)) {
        ...
        $bodyParagraphs = ["Name: {$name}", "Email: {$email}", "Message:", $message];
        $bodyOLD = join(PHP_EOL, $bodyParagraphs);
        $body2 = "If there is a change in your RSVP, please contact Emiley at {$toEmiley}.<br><br>Here's a copy of your RSVP:<br><br>Name: {$name} <br>Email: {$email}<br>Guests: {$guests}<br><br>The wedding is INVITE only and will be held at the historic Hinton freight depot.<br><br><br>Hinton Station<br>100 2nd Ave, Hinton, WV 25951 <br>(800) 872-7245<br><br><a href='https://www.google.com/maps/dir//Hinton+Station,+100+2nd+Ave+%26+Maple+Ave,+Hinton,+WV+25951/@37.6749618,-80.8948094,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x884e812ec7763b2f:0x48a67f69f05468d1!2m2!1d-80.8922345!2d37.6749618?entry=ttu'>Click here to get directions.</a>";
	...
	<div id="fh5co-couple">
		...
		<br><br>
			<div class="animate-box text-center px-5 mx-5 p-5 m-5" style="width:85%;margin:auto;">
				...
				Ceremony and reception will be held at the hisotric Hinton freight depot. The ceremony will be 
